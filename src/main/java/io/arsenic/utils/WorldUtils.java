...
public final class WorldUtils {
	...
	public static PlayerEntity findNearestPlayer(PlayerEntity toPlayer, float range, boolean seeOnly, boolean excludeFriends) {
		...
		for (PlayerEntity player : mc.world.getPlayers()) {
			...
			if(excludeFriends && Arsenic.INSTANCE.getModuleManager().getModule(Friends.class).disableAimAssist.getValue() && Arsenic.INSTANCE.getFriendManager().isFriend(player))
				continue;
