		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Arsenic.INSTANCE.getModuleManager().getModules()) {
					JsonElement moduleJson = profile.get(String.valueOf(Arsenic.INSTANCE.getModuleManager().getModules().indexOf(module)));
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Arsenic.INSTANCE.getModuleManager().getModules()) {
					...
					profile.add(String.valueOf(Arsenic.INSTANCE.getModuleManager().getModules().indexOf(module)), moduleConfig);
				}
